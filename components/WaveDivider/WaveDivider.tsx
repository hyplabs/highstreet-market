...
export default function WaveDivider(props: WaveDividerProps = defaultProps) {
	...
	const fillColor = theme.extend.colors[filledProps.color] || filledProps.color

	return (
		<div className={`${styles.wave} bg-${filledProps.bgColor}`}>
			<svg
				data-name='Layer 1'
				xmlns='http://www.w3.org/2000/svg'
				viewBox='0 0 1440 200'
				preserveAspectRatio='none'
				className={props.flipped ? styles.flipped : ''}
